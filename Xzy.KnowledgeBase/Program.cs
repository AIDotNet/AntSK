...
builder.Services.AddServicesFromAssemblies("Xzy.KnowledgeBase.Domain");
builder.Services.AddSwaggerGen(c =>
{
    c.SwaggerDoc("v1", new() { Title = "Xzy.KnowledgeBase.Api", Version = "v1" });
...
app.UseSwaggerUI(c =>
{
    c.SwaggerEndpoint("/swagger/v1/swagger.json", "Xzy.KnowledgeBase API"); //注意中间段v1要和上面SwaggerDoc定义的名字保持一致
});
